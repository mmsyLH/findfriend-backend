...
import asia.lhweb.findfriend.mapper.BlogMapper;
import asia.lhweb.findfriend.model.enums.MessageTypeEnum;
import asia.lhweb.findfriend.model.request.BlogAddRequest;
import asia.lhweb.findfriend.model.request.BlogUpdateRequest;
...
import asia.lhweb.findfriend.model.domain.BlogLike;
...
import asia.lhweb.findfriend.service.BlogLikeService;
...
public class BlogServiceImpl extends ServiceImpl<BlogMapper, Blog>
    ...
    public Page<BlogVO> listMyBlogs(long currentPage, Long id) {
        ...
        Page<Blog> blogPage = this.page(new Page<>(currentPage, SystemConstants.PAGE_SIZE), blogLambdaQueryWrapper);
    ...
    public void likeBlog(long blogId, Long userId) {
        RLock lock = redissonClient.getLock(RedissonConstant.BLOG_LIKE_LOCK + blogId + ":" + userId);
        try {
