...
public final class RedisConstants {
    ...
    public static final String LOGIN_USER_KEY = "findfriend:login:token:";

    public static final Long LOGIN_USER_TTL = 15L;
    /**
     * 注册验证码键
     */
    public static final String REGISTER_CODE_KEY = "findfriend:register:";
    /**
     * 注册验证码过期时间
     */
     ...
     * 用户忘记密码键
     */
    public static final String USER_FORGET_PASSWORD_KEY = "findfriend:user:forget:";
    /**
     * 用户忘记密码过期时间
     */
     ...
     * 博客推送键
     */
    public static final String BLOG_FEED_KEY = "findfriend:feed:blog:";
    /**
     * 新博文消息键
     */
    public static final String MESSAGE_BLOG_NUM_KEY = "findfriend:message:blog:num:";
    /**
     * 新点赞消息键
     */
    public static final String MESSAGE_LIKE_NUM_KEY = "findfriend:message:like:num:";
    /**
     * 用户推荐缓存
     */
    public static final String USER_RECOMMEND_KEY = "findfriend:recommend:";
